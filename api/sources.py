...
USGSGageHeight = USGSBase(
    "usgs_nwis_gageheight", "USGS NWIS Gage Height", "00065", "stream_gauge"
)
USGSDepthToWater = USGSBase(
    "usgs_nwis_depthtowater",
    "USGS NWIS Depth to Water",
    "72019",
    "continuous_groundwater",
)
USGSRainGauge = USGSBase(
    "usgs_nwis_rain_gauge", "USGS NWIS Rain Gauge", "00045", "continuous_rain_gauge"
)
